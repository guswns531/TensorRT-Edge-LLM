...
//!
//! The ten fields are the complete set of symbolic dims used by LLM and SpecDecode
...
struct InferenceDims
{
    ...
    int64_t tokenBatch; //!< Token carrier batch (normally batch; packed prefill uses 1)
...
static_assert(sizeof(InferenceDims) == 10 * sizeof(int64_t),
    ...
    "method in LLMEngineConfig (prefillDims / packedPrefillDims / decodeDims / specVerifyDims / "
